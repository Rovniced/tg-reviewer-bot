...
from src.config import ReviewConfig, SubmitConfig
...
async def confirm_submission(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if origin_message.media_group_id:
        ...
        if origin_message.sticker and "STICKER" in SubmitConfig.SUBMITTER_TYPE:
            ...
            # text with sticker
            text = ""
        if origin_message.animation and "ANIMATION" in SubmitConfig.SUBMITTER_TYPE:  # GIF
        ...
        elif origin_message.document and "DOCUMENT" in SubmitConfig.SUBMITTER_TYPE:
